...
const { client, createReport, getOpenReports, _getReport, closeReport, createReportComment} = require('../db/index');

// const { client.connect } = require('../innit_db')
...
describe('Database', () => {
  ...
  describe('Reports', () => {
    let testReport, testReportToClose, reports, singleReport, createReport1;
    ...
    describe('getOpenReports', () => {
      beforeAll(async() => {
        ...
        [expiredReport] = reports.filter(report => report.isExpired === true);
      })
